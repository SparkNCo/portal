export const mock_edge_function_data = {
  project_owner_name: 'Gaston Barossi',
  project_owner_email: 'gastibarossi@gmail.com',
  project_owner_phone: '2635100010',
  business_name: 'Spark & Co',
  project_status: 'GENERATING_REVENUE',
  project_description:
  ...
  project_requirements: [
    'add_product_offering',
    'new_feature',
    'migrate_lecay_systems',
    'automante_operations',
  ],
  budget: 10000,
  timeline: '6 months',
};
