...
// admin steps in to un-stick a claim someone else forgot about) so another
// assigned developer can claim it. Only the original claimer or an admin may
// release it. Surfaced in the UI as the "Unassign" button (admin-only, on a
// request claimed by someone else) — see document-requests-list.tsx.
